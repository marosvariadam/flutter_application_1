      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) => _AthleteChip(
                  ...
                  onTap: () => context.push('/athlete-detail/${athletes[index].id}'),
                ),
              ),
            ),
            const SizedBox(height: DT.s5),
            ...
            const SizedBox(height: DT.s3),
            ...athletes.map(
              (a) => _AthleteWeekRow(athlete: a, weekStart: monday),
            ),
          ],
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(
          child: _StatCard(
            color: DT.cardBlue.withOpacity(0.35),
        ...
        Expanded(
          child: _StatCard(
            color: DT.cardTeal.withOpacity(0.35),
            value: '${athletes.length * 3}',
            label: 'Edzés / hét',
        ...
        Expanded(
          child: _StatCard(
            color: DT.cardYellow.withOpacity(0.5),
            value: '$activeStreaks',
            label: 'Aktív streak',
...
class _AthleteWeekRow extends StatelessWidget {
  ...
  static const _workoutDays = {0, 2, 4}; // Mon, Wed, Fri
              ...
              children: [
                ...
                Row(
                  children: List.generate(7, (i) {
                    ...
                    final hasWorkout = _workoutDays.contains(i);
                    final isPast = day.isBefore(DateTime(today.year, today.month, today.day));

                    Color bg;
                    Color textColor;
                    if (hasWorkout) {
                      bg = isPast ? DT.difficultyLight : DT.metricBlue;
                      textColor = Colors.white;
                    } else {
                      bg = DT.bg;
                      textColor = DT.textSecondary;
                    }
